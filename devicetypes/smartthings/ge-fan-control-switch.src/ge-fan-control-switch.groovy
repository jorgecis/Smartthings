...
metadata {
	...
	definition (name: "GE Fan Control Switch", namespace: "smartthings", author: "SmartThings") {
...
def medSpeed() {
	def medThresholdvalue = (settings.medThreshold != null && settings.medThreshold != "") ? settings.medThreshold.toString()  : "60"
